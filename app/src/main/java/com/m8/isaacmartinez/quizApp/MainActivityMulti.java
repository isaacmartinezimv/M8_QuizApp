...
public class MainActivityMulti extends AppCompatActivity
        implements QuestionsMultiFragment.QuestionsFragmentListenerTwo{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QuestionsMultiFragment questionsMultiFragment = QuestionsMultiFragment.newInstance();
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.fragmentContainer, questionsMultiFragment)
                .commit();
    ...
    public String compareAnswere(Integer answerGiven){
        ...
        if (!gameFinished) {
            ...
            if (QuestionMultiList.checkAnswere(answerGiven)) {
